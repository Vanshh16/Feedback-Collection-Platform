  ...
  return (
    <Container component="main" maxWidth="lg" sx={{ height: 'calc(100vh - 64px)', display: 'flex' }}>
      <Grid container sx={{ flexGrow: 1 }}>
          ...
          >
            ...
            >
                ...
                <Typography variant="body1" sx={{ color: 'text.secondary' }}>
                    Create an account to build powerful, insightful forms in minutes.
                </Typography>
            </motion.div>
          </Grid>
        )}
        ...
        <Grid size={6} item xs={12} sm={12} md={5} component={Paper} elevation={6} square sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: isMobile ? 'transparent' : 'background.paper', boxShadow: isMobile ? 'none' : 'inherit' }}>
          <motion.div
